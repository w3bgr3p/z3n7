...
namespace z3n7.Socials
{
    ...
    public class Google
    {
        ...
        /// </summary>
        public Google(IZennoPosterProjectModel project, Instance instance, Logger log = null)
        {
            if (instance == null)
        ...
        /// </summary>
        public Google(IZennoPosterProjectModel project, Logger log = null)
        {
            _project = project;
            _instance = null;
            _log = log;
