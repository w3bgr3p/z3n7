...
namespace z3n7.Wallets
{
    public class ZerionWallet : IWallet
    {
        ...
        public ZerionWallet(IZennoPosterProjectModel project, Instance instance, Logger log = null, string key = null, string fileName = "Zerion1.21.3.crx")
        {
            _project = project;
            _instance = instance;
            _fileName = fileName;
